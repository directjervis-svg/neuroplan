...
/**
 * Dashboard Barkley - Layout NotebookLM Idêntico
 * 
 * Estrutura:
...
export default function DashboardBarkley() {
    ...
    return (
      <div className="flex items-center justify-center h-screen bg-white">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mb-2">Nenhum ciclo ativo</h2>
          <p className="text-gray-600 mb-6">Crie seu primeiro ciclo de 3 dias para começar</p>
          <Link href="/projects">
  ...
  return (
    <div className="flex h-screen bg-white overflow-hidden">
      ...
      {/* LEFT PANEL - 30-35% */}
      <aside className={`${
        mobileMenuOpen ? "fixed inset-0 z-40 md:relative md:inset-auto" : "hidden md:flex"
      ...
      {/* RIGHT PANEL - 20-25% */}
      <aside className="hidden lg:flex flex-col w-1/4 border-l border-gray-200 bg-white">
